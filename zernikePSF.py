...
class zernikePSF:
    ...
    def makeZernikePSF(
        self, coeffs=(0, 0, 0, 0, 0), show=False, units="microns", extraPlots=False
    ):
        # RADIUS = 1.0 # meters
    ...
    def saveToRSoft(self, outfile="PSFOut", size_data=400):
        """
    ...
    def makeMultiplePSFs(
        ...
        allOutfiles = []
        allData = []
        for ind, coeffs in enumerate(coeffsList):
            ...
            for c in coeffs:
                ...
                elif trimLeadingCoeffnames is "seq":
